...
- **Round Positive Decimal Infinity Edge Case**

  ![Round Positive Decimal Infinity Edge Case-1](roundDecInfinity-P1.png)
  ![Round Positive Decimal Infinity Edge Case-2](roundDecInfinity-P2.png)

- **Round Negative Decimal Infinity Edge Case**
...
- **Round Unsigned Binary**
  ...
  ![Round Unsigned Binary-2](UnsignedBinary-2.png)

- **Round Signed Binary Positive**

  ![Round Signed Binary Positive-1](SignedBinary-P1.png)
  ![Round Signed Binary Positive-2](SignedBinary-P2.png)

- **Round Signed Binary Negative**
...
- **Round IEEE-754 Hex**
  ...
  ![Round IEEE-754 Hex-2](ieeeHex-P2.png)

- **Round IEEE-754 Binary**

  ![Round IEEE-754 Binary-1](ieeeBinary-P1.png)
  ![Round IEEE-754 Binary-2](ieeeBinary-P2.png)

- **Round IEEE-754 Binary Positive Infinity**

  ![Round IEEE-754 Hex-1](ieeeInfinity-P1.png)
  ![Round IEEE-754 Hex-2](ieeeInfinity-P2.png)

- **Round IEEE-754 Binary Negative Infinity**
...
- **Add Exact Decimal (HEX)**
  ...
  ![Add Exact Decimal](addhexexactdecimal.png)

- **Add Misalignment (HEX)**

  ![Add Misalignment](addhexmisalignment.png)

- **Add Mixed Signs (HEX)**

  ![Add Mixed Signs](addhexmixedsigns.png)

- **Add Negatives (HEX)**

  ![Add Negatives](addhexnegatives.png)

- **Add Precision (HEX)**

  ![Add Precision](addhexprecision.png)
